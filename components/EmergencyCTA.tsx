        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
            <a
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-3 bg-white hover:bg-slate-100 text-emergency-600 px-8 py-4 rounded-2xl text-xl font-bold font-heading tracking-wide shadow-2xl transition-all hover:scale-105 active:scale-95"
            >
              <Phone className="w-6 h-6 text-emergency-600 animate-bounce" />
            ...
            <a
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-3 bg-black/40 hover:bg-black/60 text-white border border-white/30 px-8 py-4 rounded-2xl text-xl font-bold font-heading tracking-wide transition-all hover:scale-105"
            >
